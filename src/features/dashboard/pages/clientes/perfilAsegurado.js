            ...
            <div className="panel-body">
                ...
                <table className="table table-hover" style={{ marginBottom: "0px" }}>
                    <tbody>
                        ...
                        <tr><td width="30%">Codigo Postal</td><td width="70%">{codigoPostal}</td></tr>
                        ...
                        <tr><td width="30%">Regimen Vivienda</td><td width="70%">{regimenVivienda}</td></tr>
                        <tr><td width="30%">Situacion Laboral</td><td width="70%">{situacionLaboral}</td></tr>
